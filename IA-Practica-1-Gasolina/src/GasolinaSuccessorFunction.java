            ...
            for (int j = 0; j < truck1.getTripsSize(); ++j){
                for (int i2 = 0; i2 < presentState.getTrucksSize(); ++i2){
                    ...
                    for (int j2 = 0; j2 < truck2.getTripsSize(); ++j2){
                        if (i2 != i){
                            double profitTruck1 = truck1.getTripAt(j).getProfit(truck1.getOrigin());
                            double profitTruck2 = truck2.getTripAt(j2).getProfit(truck2.getOrigin());
                            ...
                            newProfitTruck1 = aux.getTruckAt(i).getTripAt(j).getProfit(aux.getTruckAt(i).getOrigin());
                            newProfitTruck2 = aux.getTruckAt(i2).getTripAt(j2).getProfit(aux.getTruckAt(i2).getOrigin());
