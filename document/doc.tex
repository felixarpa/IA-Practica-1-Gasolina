...
En las siguiente tabla y gráfica representamos el tiempo de ejecución de Hill Climbling según el número de centros con los que operaban:

\begin{table}[H]
\centering
\begin{tabular}{@{}lllll@{}}
\textbf{Centros de distribución} & \textbf{Tiempo de ejecución (ms)} \\ \hline
